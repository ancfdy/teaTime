package com.teatime.library_teatime.Utils.commonutil;
...
public class AppApplicationMgr {
    ...
    public static String getMetaData(Context context, String key) {
        ...
        try {
            ApplicationInfo e = context.getPackageManager().getApplicationInfo(context.getPackageName(), PackageManager.GET_META_DATA);
            if(null != e) {
